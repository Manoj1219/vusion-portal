<template>
	...
	<section class="mds-section mds-background-secondary-shade mds-p-vertical-4xl">
		<div class="mds-container">
			<div class="mds-p-vertical-4xl">
				...
				<a target="_blank" class="mds-button mds-button-secondary mds-m-top-3xl mds-width-max" href="">
					Discover more
				</a>
			</div>
	...
	<section class="mds-container mds-p-top-7xl">
		<div class="mds-section-content productBlock cloud mds-p-around-none mds-m-bottom-7xl">
		...
		<div class="mds-m-vertical-5xl mds-p-top-7xl">
			<div
				...
				<div class="mds-p-vertical-6xl mds-p-left-6xl mds-p-right-2xl mds-text-color-white">
					...
					<p class="mds-font-size-base-2 mds-font-weight-300 mds-line-height-xl">
					...
					<a target="_blank" href="/" class="mds-button mds-button-secondary mds-m-top-3xl mds-width-max">
						Learn more here
					</a>
				</div>
				<div>
	...
	<section class="mds-p-top-2xl">
		<div class="mds-carousal mds-products-carousal mds-m-vertical-7xl">
			<Swiper :space-between="30" :slidesPerView="'auto'" :modules="modules" class="mds-swiper default-swiper"
				@swiper="setSwiperRef" @slideChange="(swiper) => (activeSlide = swiper.activeIndex)" navigation
				pagination>
				<SwiperSlide v-for="(video, index) in ElectronicShel.videos" :key="index">
					<button class="video-button" @click="togglePlay(index)">
						<video ref="videoRefs" class="video" :poster="video.poster" :src="video.src" playsinline
							controls @playing="playingIndex = index" @pause="playingIndex = null"></video>
						<!-- <div v-if="playingIndex !== index" class="play-overlay">▶</div> -->
					</button>
				</SwiperSlide>
			</Swiper>
			...
			<div class="mds-container mds-flex mds-items-center mds-p-left-xl">
				...
				<div class="mds-button-group-carousel">
					<button class="mds-button mds-button-primary_outline" @click="slideTo(activeSlide - 1)">
	...
	<section class="mds-section-content mds-container mds-p-top-lg">
		<FaqAccordion productKey="ElectronicShel" />
	</section>
				...
				<div class="mds-grid mds-grid-size-3 mds-gap_column-lg">
					<a href="#" class="mds-flex-column">
						...
						<div class="insights-image">
							q
							<img src="https://www.vusion.com/wp-content/uploads/2023/11/price-tags-for-clothing-1-393x262-c-default.png"
								alt="" />
						</div>
					</a>
					<a href="#" class="mds-flex-column">
						...
						<div class="insights-image">
							q
							<img src="https://www.vusion.com/wp-content/uploads/2023/11/Grocery-393x262-c-default.png"
								alt="" />
						</div>
					</a>
					<a href="#" class="mds-flex-column">
						...
						<div class="insights-image">
							q
							<img src="https://www.vusion.com/wp-content/uploads/2023/11/furniture-tags-393x262-c-default.png"
								alt="" />
						</div>
					</a>
				</div>
...
const stopAllVideos = () => {
	videoRefs.value.forEach((v) => v && v.pause());
};

onMounted(() => {
	// Init refs to actual DOM video elements
	videoRefs.value = document.querySelectorAll("video");
});
</script>
