    ...
    <div class="ecosystem-section">
      <div class="mds-container">
        ...
        <div class="tabsContainer">
          <div class="tabsButtonWrapper mds-scroll-auto">
            <button
              class="eachTabButton mds-button-slider-link"
              v-for="(tab, i) in OverviewTabsData"
              :key="i"
              @click="currentTab = i"
    ...
    <div class="soultions-section">
      <div class="mds-container">
        ...
        <div class="mds-m-top-xl mds-grid mds-grid-size-2 mds-gap-around-3xl">
          <div
            class="product-card"
            v-for="(product, index) in OverviewPageData.exploreSolutions.list"
            :key="index"
          >
            ...
            <div class="product-card-body">
              ...
              <p
                class="mds-font-weight-700 mds-flex mds-m-bottom-base"
                v-for="feature in product.list"
                :key="feature"
              >
