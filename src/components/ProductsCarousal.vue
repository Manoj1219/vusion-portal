        ...
        <swiper :spaceBetween="30" :slidesPerView="'auto'" :modules="modules" class="mds-swiper" @swiper="setSwiperRef">
            <swiper-slide v-for="item in carousalItems" :key="item.id" :class="item.background">
                <div
                    ...
                    <div class="mds-flex mds-flex-column mds-gap-around-xl mds-items-start mds-width-60">
                        ...
                        <router-link :to="item.link" class="mds-button mds-button-primary_outline mds-button-animate">
                            Explore solutions
                            <i class="pi pi-arrow-right"></i>
                        </router-link>
                    </div>
                </div>
                <div class="mds-flex mds-gap-around-2xl mds-items-center mds-p-vertical-2xl">
                    <div class="mds-flex mds-gap-around-lg mds-items-center" v-for="feature in item.features"
                        :key="feature.title">
