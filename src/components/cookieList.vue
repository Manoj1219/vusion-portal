<template>
  <div class="cookie-policy-container">
    <h1 class="mds-font-weight-700 mds-font-size-base-2 mds-m-bottom-xl">
      Cookie List
    </h1>
    <p class="description">
    ...
    <h2 class="mds-font-weight-700 mds-font-size-base-2 mds-m-bottom-xl">
      Strictly Necessary Cookies
    </h2>
        ...
        <tr>
          ...
          <td>
            <a
              ...
              target="_blank"
              rel="noopener"
              >__uxq412__ses.580c</a
            >,
            <a
              href="https://cookiepedia.co.uk/cookies/__uxq412__id.580c"
              target="_blank"
              rel="noopener"
              >__uxq412__id.580c</a
            >
      ...
      <tbody>
        ...
        <tr class="background-light-gray">
          ...
          <td>
            ...
            >,
            <a
              href="https://cookiepedia.co.uk/cookies/pardot"
              target="_blank"
              rel="noopener"
              >pardot</a
            >,
        ...
        <tr>
          ...
          <td>
            ...
            >,
            <a
              href="https://cookiepedia.co.uk/cookies/_gcl_au"
              target="_blank"
              rel="noopener"
              >_gcl_au</a
            >
