<template>
  ...
  <div class="mds-carousal mds-products-carousal mds-m-vertical-4xl">
    ...
    >
      ...
      >
        <div
          class="mds-mobile-flex mds-gap-around-5xl mds-items-center mds-p-top-2xl mds-height-px-600"
        >
          <div class="mds-width-50">
            ...
            <div
              ...
              :key="block.id"
              class="mds-mobile-flex mds-column-gap-3 mds-row-gap-1 mds-border-default-top mds-p-vertical-xl"
            >
              <span
