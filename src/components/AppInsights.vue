<template>
	<div class="mds-grid mds-gap_around-4xl mds-m-top-6xl">
		<div class="mds-grid mds-grid-size-3 mds-gap_column-lg">
			<router-link class="mds-flex-column" v-for="(item, index) in insightsLabels" :key="index"
				:to="item.routeTo">
				<div class="insights-content">
					...
					<div class="insights-meta">{{ item.updated }}</div>
				</div>
				<div class="insights-image" v-if="item.img">
					<img src="https://www.vusion.com/wp-content/uploads/2024/04/Shopper-Engagement@2x-100-scaled-1179x786-c-default.jpg"
						alt="" />
				</div>
			</router-link>
		</div>
...
const insightsLabels = appData?.insightsSection.list;
</script>
